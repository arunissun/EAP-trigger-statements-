"""
Azure OpenAI LLM Extractor module for the Trigger Statement Extraction Pipeline.

Handles Azure OpenAI API interaction and trigger extraction using GPT-3.5 Turbo.
"""
...
# =============================================================================
# Prompts (Same as Gemini version for consistency)
# =============================================================================
...
def extract_triggers_with_openai(payload: str) -> dict:
    """
    Send payload to Azure OpenAI API and extract trigger statements.
    ...
    print(f"  Sending {len(payload)} characters to Azure OpenAI...")
    ...
    try:
        ...
        print(f"  Error during Azure OpenAI extraction: {e}")
        return {"error": str(e)}
