...
Usage:
    python analyze_variable_frequency.py [--llm openai|gemini] [--min-frequency N] [--coverage PCT]
"""
...
if __name__ == "__main__":
    ...
    if args.save:
        ...
        output_file = output_dir / f"variable_frequency_{args.llm}.json"
        save_filtered_schema(stats, normalized_csv, output_file, args.min_frequency)
